        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('board_member', 1, old('board_member', old('board_member')), ['required' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('board_member'))
                        <p class="help-block">
                            {{ $errors->first('board_member') }}
                        </p>
                    @endif
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('position_name', trans('quickadmin.users.fields.position-name').'', ['class' => 'control-label']) !!}
                    {!! Form::text('position_name', old('position_name'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('pronouns', trans('quickadmin.users.fields.pronouns').'', ['class' => 'control-label']) !!}
                    {!! Form::text('pronouns', old('pronouns'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
