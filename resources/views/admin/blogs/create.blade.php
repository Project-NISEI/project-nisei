...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.blogs.store']]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('title', trans('quickadmin.blog.fields.title').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('slug', trans('quickadmin.blog.fields.slug').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('published_at', trans('quickadmin.blog.fields.published-at').'*', ['class' => 'control-label']) !!}
                    {!! Form::text('published_at', old('published_at'), ['class' => 'form-control date', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('author_id', trans('quickadmin.blog.fields.author').'*', ['class' => 'control-label']) !!}
                    {!! Form::select('author_id', $authors, old('author_id'), ['class' => 'form-control select2', 'required' => '']) !!}
                    <p class="help-block"></p>
